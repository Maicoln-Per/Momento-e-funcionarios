...
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,senha,telefone,data_contratacao,cargo_id,salario,gerente_id,departamento_id) VALUES (555,'Maicoln','Pereira de Sousa','maicolnp@gmail.com','maicolalindo40028922','523.967.878-97','2023-03-06',8,5500.00,100,10);
UPDATE funcionarios
SET departamento_id = 6
WHERE funcionario_id = 555;
...
select count(*) as funcionarios_no_financas from funcionarios where departamento_id = "10";
...
UPDATE cargos
SET cargo_nome = "Gerente de Inovações"
WHERE cargo_id = 22;
